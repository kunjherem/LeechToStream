...
class Config(object):
    ...
    CANCEL_COMMAND_G = os.environ.get("CANCEL_COMMAND_G", "cancel@leechXTbot")
    GET_SIZE_G = os.environ.get("GET_SIZE_G", "getsize")
    STATUS_COMMAND = os.environ.get("STATUS_COMMAND", "status")
    SAVE_THUMBNAIL = os.environ.get("SAVE_THUMBNAIL", "savethumbnail@leechXTbot")
    CLEAR_THUMBNAIL = os.environ.get("CLEAR_THUMBNAIL", "clearthumbnail@leechXTbot")
